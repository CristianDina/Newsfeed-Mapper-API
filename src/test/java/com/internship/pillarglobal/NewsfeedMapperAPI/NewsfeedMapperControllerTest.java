...
public class NewsfeedMapperControllerTest {
    ...
    @Test
    public void triggerYahooUK_sadXML() throws Exception {
        List<YahooUKItem> provided= Arrays.asList(new YahooUKItem("a","a",new Date(),true,"a1","ana","a","a","a"),new YahooUKItem("b","b",new Date(),true,"b1","bob","b","b","b"));
        Mockito.when(yahooUKClient.getRssFeed()).thenThrow(new FailedToReadDataFromXml(""));
        mockMvc.perform(MockMvcRequestBuilders
                .post("/triggerYahooUK"))
                .andExpect(status().isInternalServerError());
        Mockito.verify(yahooUKClient, Mockito.times(1)).getRssFeed();
        Mockito.verify(yahooUKRepository, Mockito.times(0)).save(provided.get(0));
        Mockito.verify(yahooUKRepository, Mockito.times(0)).save(provided.get(1));
    }

    @Test
    public void triggerYahooUK_sadDB() throws Exception {
        List<YahooUKItem> provided= Arrays.asList(new YahooUKItem("a","a",new Date(),true,"a1","ana","a","a","a"),new YahooUKItem("b","b",new Date(),true,"b1","bob","b","b","b"));
        Mockito.when(yahooUKClient.getRssFeed()).thenReturn(provided);
        Mockito.when(yahooUKRepository.save(provided.get(0))).thenThrow(new FailedToStoreInDatabase(""));
        mockMvc.perform(MockMvcRequestBuilders
                .post("/triggerYahooUK"))
                .andExpect(status().isInternalServerError());
        Mockito.verify(yahooUKClient, Mockito.times(1)).getRssFeed();
    ...
    @Test
    public void triggerYahooUS_sadXML() throws Exception {
        List<YahooUSItem> provided= Arrays.asList(new YahooUSItem("a","a",new Date(),true,"a1","ana","a","a","a"),new YahooUSItem("b","b",new Date(),true,"b1","bob","b","b","b"));
        Mockito.when(yahooUSClient.getRssFeed()).thenThrow(new FailedToReadDataFromXml(""));
        mockMvc.perform(MockMvcRequestBuilders
                .post("/triggerYahooUS"))
                .andExpect(status().isInternalServerError());
        Mockito.verify(yahooUSClient, Mockito.times(1)).getRssFeed();
        Mockito.verify(yahooUSRepository, Mockito.times(0)).save(provided.get(0));
        Mockito.verify(yahooUSRepository, Mockito.times(0)).save(provided.get(1));
    }

    @Test
    public void triggerYahooUS_sadDB() throws Exception {
        List<YahooUSItem> provided= Arrays.asList(new YahooUSItem("a","a",new Date(),true,"a1","ana","a","a","a"),new YahooUSItem("b","b",new Date(),true,"b1","bob","b","b","b"));
        Mockito.when(yahooUSClient.getRssFeed()).thenReturn(provided);
        Mockito.when(yahooUSRepository.save(provided.get(0))).thenThrow(new FailedToStoreInDatabase(""));
        mockMvc.perform(MockMvcRequestBuilders
                .post("/triggerYahooUS"))
                .andExpect(status().isInternalServerError());
        Mockito.verify(yahooUSClient, Mockito.times(1)).getRssFeed();
    ...
    @Test
    public void triggerMsnUK_sadXML() throws Exception {
        List<MsnUKItem> provided= Arrays.asList(new MsnUKItem("aaa","a","a",new Date(),"a","a","a",new Date(),true,"aa",null),new MsnUKItem("b","a","a",new Date(),"a","a","a",new Date(),true,"aa",new Content("s","s","d","s","s",3,new Thumbnail("t","t"))));
        Mockito.when(msnUKClient.getRssFeed()).thenThrow(new FailedToReadDataFromXml(""));
        mockMvc.perform(MockMvcRequestBuilders
                .post("/triggerMsnUK"))
                .andExpect(status().isInternalServerError());
        Mockito.verify(msnUKClient, Mockito.times(1)).getRssFeed();
        Mockito.verify(msnUKRepository, Mockito.times(0)).save(ItemMapper.mapMsnUKItemToDBItem(provided.get(0)));
        Mockito.verify(msnUKRepository, Mockito.times(0)).save(ItemMapper.mapMsnUKItemToDBItem(provided.get(1)));
    }

    @Test
    public void triggerMsnUK_sadDB() throws Exception {
        List<MsnUKItem> provided= Arrays.asList(new MsnUKItem("aaa","a","a",new Date(),"a","a","a",new Date(),true,"aa",null),new MsnUKItem("b","a","a",new Date(),"a","a","a",new Date(),true,"aa",new Content("s","s","d","s","s",3,new Thumbnail("t","t"))));
        Mockito.when(msnUKClient.getRssFeed()).thenReturn(provided);
        Mockito.when(msnUKRepository.save(ItemMapper.mapMsnUKItemToDBItem(provided.get(0)))).thenThrow(new FailedToStoreInDatabase(""));
        mockMvc.perform(MockMvcRequestBuilders
                .post("/triggerMsnUK"))
                .andExpect(status().isInternalServerError());
        Mockito.verify(msnUKClient, Mockito.times(1)).getRssFeed();
    ...
    @Test
    public void triggerMsnUS_sadXML() throws Exception {
        List<MsnUSItem> provided= Arrays.asList(new MsnUSItem("abb","a","a",new Date(),"a","a","a",new Date(),true,"aa",new Content("s","s","d","s","s",3,new Thumbnail("t","t"))),new MsnUSItem("a","a","a",new Date(),"a","a","a",new Date(),true,"aa",new Content("s","s","d","s","s",3,new Thumbnail("t","t"))));
        Mockito.when(msnUSClient.getRssFeed()).thenThrow(new FailedToReadDataFromXml(""));
        mockMvc.perform(MockMvcRequestBuilders
                .post("/triggerMsnUS"))
                .andExpect(status().isInternalServerError());
        Mockito.verify(msnUSClient, Mockito.times(1)).getRssFeed();
        Mockito.verify(msnUSRepository, Mockito.times(0)).save(ItemMapper.mapMsnUSItemToDBItem(provided.get(0)));
        Mockito.verify(msnUSRepository, Mockito.times(0)).save(ItemMapper.mapMsnUSItemToDBItem(provided.get(1)));
    }

    @Test
    public void triggerMsnUS_sadDB() throws Exception {
        List<MsnUSItem> provided= Arrays.asList(new MsnUSItem("abb","a","a",new Date(),"a","a","a",new Date(),true,"aa",new Content("s","s","d","s","s",3,new Thumbnail("t","t"))),new MsnUSItem("a","a","a",new Date(),"a","a","a",new Date(),true,"aa",new Content("s","s","d","s","s",3,new Thumbnail("t","t"))));
        Mockito.when(msnUSClient.getRssFeed()).thenReturn(provided);
        Mockito.when(msnUSRepository.save(ItemMapper.mapMsnUSItemToDBItem(provided.get(0)))).thenThrow(new FailedToStoreInDatabase(""));
        mockMvc.perform(MockMvcRequestBuilders
                .post("/triggerMsnUS"))
                .andExpect(status().isInternalServerError());
        Mockito.verify(msnUSClient, Mockito.times(1)).getRssFeed();
